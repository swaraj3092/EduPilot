...
- **Swaraj** — *Founder & Lead Full-Stack Architect*
  - **Primary Architect**: Engineered the entire EduPilot ecosystem from concept to production.
  - Developed the core AI Agent dual-engine (Generative + Grounded Search).
